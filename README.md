...
### Update binaries
Bot calls the following URL for update binaries: `portal.ecouser.net/api/ota/products/wukong/class/ls1ok3/firmware/latest.json?sn={???}&ver=X.X.X&module=fw0`
